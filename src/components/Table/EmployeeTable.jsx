...
import { employeeSelector } from "../../redux/selectors/employeeSelector";
      ...
      <section className="table-container">
          ...
          <Table>
            ...
            <TableBody>
              {table.getRowModel().rows.length > 0 ? (
                  ...
                  .rows.filter((row) => {
                    if (globalFilter !== null) {
                      ...
                      return Object.keys(rowData).some((key) => {
                        ...
                        return (
                          cellValue &&
                          cellValue.toString().includes(globalFilter)
                        );
                      });
                    } else {
                      return true;
                ...
                <TableRow>
                  <TableCell colSpan={9}>
                    <div className="table-empty">No employee</div>
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
        ...
        <div className="table-pagination">
          ...
          {table.getPageCount() > 0 && (
            <div className="table-pagination_input">
              <Select
